...
# ifndef CONFIG_CCXMX5X_ENABLE_EXT_ETH
#  define CONFIG_CCXMX5X_ENABLE_FEC_ETH	1
# else
#  define CONFIG_DISPLAY2_ENABLE	1
# endif
# define CONFIG_DISPLAY1_ENABLE		1
# define CONFIG_JSCCWMX51_JSK		1
...
#define CONFIG_MXC			1
#define CONFIG_CCXMX51			1	/* in a CCWi-i.MX51 or CC-i.MX51*/
#define CONFIG_CCXMX5X			1	/* in a CCWi-i.MX51 or CCWi-i.MX53 */
#define CONFIG_ARCH_CPU_INIT
#define CONFIG_ARCH_MMU
//#define CONFIG_ICACHE_L1_OFF
#define CCXMX51_CPU_FREQ_600		1	/* start at 600MHz */
#define CONFIG_PLATFORM_HAS_HWID
#define CONFIG_HWID_LENGTH		6
#define CONFIG_DONT_ENABLE_ALL_CLKS	1


#ifdef CONFIG_HAS_WIRELESS
#define CONFIG_CCWMX51			1	/* in a CCWi-i.MX51 */
#define CONFIG_MODULE_NAME		"ccwmx51"
#define CONFIG_MODULE_NAME_UPPERCASE	"CCWMX51"
#define CONFIG_MODULE_STRING		"ConnectCore Wi-i.MX51"
#else
#define CONFIG_CCMX51			1	/* in a CC-i.MX51 */
#define CONFIG_MODULE_NAME		"ccmx51"
#define CONFIG_MODULE_NAME_UPPERCASE	"CCMX51"
#define CONFIG_MODULE_STRING		"ConnectCore i.MX51"
#endif
#define CONFIG_PLATFORM_NAME		CONFIG_MODULE_NAME PLATFORM
#define CONFIG_SYS_PROMPT		CONFIG_MODULE_NAME_UPPERCASE " # "
...
/* Define settings depending on the selected CCWMX51JS board */
#if defined(CONFIG_JSCCWMX51_EAK)
#define BOARD_USER_KEY1_GPIO		MX51_PIN_GPIO1_8
#elif defined(CONFIG_JSCCWMX51_JSK)
...
#ifdef CONFIG_CCXMX5X_ENABLE_FEC_ETH
...
#ifdef CONFIG_CCXMX5X_ENABLE_EXT_ETH
...
/** Load addresses */
#define CONFIG_LOADADDR			0x94000000	/* default load address	*/
#define CONFIG_ANDROID_LOAD_ADDR	0x92000000
#ifdef CONFIG_CCXMX5_SDRAM_128MB
# define CONFIG_WCE_LOAD_ADDR		0x94000000	/* 64MiB offset of first bank */
#else
# define CONFIG_WCE_LOAD_ADDR		CSD1_BASE_ADDR	/* base address of second bank */
#endif

#define CONFIG_INITRD_LOAD_ADDR		0x92000000
 ...
 * Environment
 */
#if defined(CONFIG_CCXMX5X_ENABLE_FEC_ETH)
# define CONFIG_ENV_ETHPRIME		"ethprime=FEC0\0"
#elif defined(CONFIG_CCXMX5X_ENABLE_EXT_ETH)
