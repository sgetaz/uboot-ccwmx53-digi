...
#define CONFIG_MXC
#define CONFIG_MX53
#define CONFIG_CCXMX53			1	/* in a CCWi-i.MX53 or CC-i.MX53 */
...
#define CONFIG_CCWMX53			1	/* in a CCWi-i.MX53 */
#define CONFIG_MODULE_NAME		"ccwmx53"
#define CONFIG_MODULE_NAME_UPPERCASE	"CCWMX53"
#define CONFIG_MODULE_STRING		"ConnectCore Wi-i.MX53"
#else
#define CONFIG_CCMX53			1	/* in a CC-i.MX53 */
#define CONFIG_MODULE_NAME		"ccmx53"
#define CONFIG_MODULE_NAME_UPPERCASE	"CCMX53"
#define CONFIG_MODULE_STRING		"ConnectCore i.MX53"
#endif
...
# if defined(CONFIG_JSCCWMX53_JSK)
...
#define CONFIG_ANDROID_LOAD_ADDR	CONFIG_LOADADDR
#if CONFIG_NR_DRAM_BANKS > 1
# define CONFIG_WCE_LOAD_ADDR		PHYS_SDRAM_2	/* base address of second bank */
#else
# define CONFIG_WCE_LOAD_ADDR		0x75000000	/* 64MiB offset of first bank */
#endif
//#define CONFIG_ZIP_LOAD_ADDR		0x93000000
#define CONFIG_LX_FAST_LOAD_ADDR        0x70007fc0      /* load address for an uncompressed kernel */
//#define CONFIG_INITRD_LOAD_ADDR		0x90600000
