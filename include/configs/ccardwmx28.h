...
#ifndef __CCARDMX28_H
#define __CCARDMX28_H
 ...
 */
#define CONFIG_CCARDXMX28		1
#ifdef CONFIG_HAS_WIRELESS
#define CONFIG_CCARDWMX28		1	/* in a CCardWi-i.MX28 */
#define CONFIG_MODULE_NAME		"ccardwmx28"
#define CONFIG_MODULE_NAME_UPPERCASE	"CCARDWMX28"
#define CONFIG_MODULE_STRING		"ConnectCard Wi-i.MX28"
#else
#define CONFIG_CCARDMX28		1	/* in a CCardWi-i.MX28 */
#define CONFIG_MODULE_NAME		"ccardmx28"
#define CONFIG_MODULE_NAME_UPPERCASE	"CCARDMX28"
#define CONFIG_MODULE_STRING		"ConnectCard i.MX28"
#endif
...
/* Unsupported common options for CCARDMX28 must be disabled */
...
#define CONFIG_PHY_RESET_GPIO		PINID_PWM4		/* for CCARDMX28 */
 ...
 * User keys
 */
#ifdef CONFIG_UBOOT_JSCCARDXMX28_V1
...
#endif /* CONFIG_UBOOT_JSCCARDXMX28_V1 */
